...
해당 예제를 실행하고, 줄랭의 커멘드 라인 옵션을 테스트하는 영상입니다.

[![줄랭 테스트](http://img.youtube.com/vi/jIKC5KnGpIs/0.jpg)](https://youtu.be/jIKC5KnGpIs)
...
위의 코드에 시간을 측정하는 부분을 추가하여, 줄랭 JIT, 줄랭 바이너리 컴파일, 파이썬의 속도를 비교하는 영상입니다.

[![줄랭 테스트](http://img.youtube.com/vi/CDEEp4LlXyM/0.jpg)](https://youtu.be/CDEEp4LlXyM)

---

줄랭으로 구현한 퀵 정렬 알고리즘입니다. 기본적으로 C라이브러리와 링킹이 되기 때문에,
아래의 rand처럼 선언만 해준다면 C언어의 함수를 쉽게 사용할 수 있습니다.
...
의도적으로 컴파일 에러를 내서 줄랭 컴파일러의 에러 메시지를 확인하고, 퀵정렬을 실행하는 영상입니다.

[![줄랭 퀵정렬](http://img.youtube.com/vi/cSZRq-xd3h8/0.jpg)](https://youtu.be/cSZRq-xd3h8)
